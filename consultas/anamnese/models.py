...
class Anamnese(models.Model):
    ...
    alunob = models.CharField(max_length=100, blank=False, null=True, verbose_name="Aluno B")
    alunoc = models.CharField(max_length=100, blank=False, null=True, verbose_name="Aluno C")
    alunod = models.CharField(max_length=100, blank=False, null=True, verbose_name="Aluno D")
