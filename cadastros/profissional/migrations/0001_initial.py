    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nm_profissional', models.CharField(max_length=100, null=True)),
                ('nu_telefone_profissional', models.CharField(max_length=100, null=True)),
                ...
                ('usuarios', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='usuarios.usuarios')),
            ],
            options={
